...
public class FoodRecipeData {
    ...
    public record Recipe(String name, int tier, List<Ingredient> ingredients, int batchSize) {
        /** Convenience constructor for standard batch-of-10 food */
        public Recipe(String name, int tier, List<Ingredient> ingredients) {
            this(name, tier, ingredients, 10);
        }
    }
    ...
    static {
        ...
        recipe1("Shallowshore Squid Salad",  2, ing("Bean", 1), ing("Arcane Agaric", 1),
        ...
        recipe("Chicken Omelette",           3, ing("Sheaf of Wheat", 4), ing("Raw Chicken", 8),
                ing("Hen Eggs", 2));
        recipe1("Lowriver Crab Omelette",     3, ing("Lowriver Crab", 1), ing("Hen Eggs", 1),
        ...
        recipe("Goose Omelette",             5, ing("Cabbage", 12), ing("Raw Goose", 24),
                ing("Goose Eggs", 6));
        recipe1("Drybrook Crab Omelette",     5, ing("Cabbage", 2), ing("Drybrook Crab", 1),
        ...
        recipe("Pork Omelette",              7, ing("Bundle of Corn", 36), ing("Raw Pork", 72),
                ing("Goose Eggs", 18));
        recipe1("Dusthole Crab Omelette",     7, ing("Bundle of Corn", 6), ing("Raw Pork", 6),
        ...
        recipe("Chicken Pie",            3, ing("Sheaf of Wheat", 2), ing("Raw Chicken", 8),
                ing("Flour", 4));
        recipe1("Upland Coldeye Pie",     3, ing("Upland Coldeye", 1), ing("Flour", 1),
                ing("Hen Eggs", 1));
        ...
        recipe("Goat Stew",             4, ing("Turnip", 4), ing("Bread", 4),
                ing("Raw Goat", 8));
        recipe1("Greenriver Eel Stew",   4, ing("Turnip", 1), ing("Greenriver Eel", 1),
        ...
        recipe("Mutton Stew",           6, ing("Potato", 12), ing("Bread", 12),
                ing("Raw Mutton", 24));
        recipe1("Redspring Eel Stew",    6, ing("Potato", 2), ing("Redspring Eel", 1),
        ...
        recipe("Beef Stew",             8, ing("Pumpkin", 36), ing("Bread", 36),
                ing("Raw Beef", 72));
        recipe1("Deadwater Eel Stew",    8, ing("Pumpkin", 6), ing("Deadwater Eel", 1),
        ...
        recipe("Goat Sandwich",                4, ing("Bread", 4), ing("Goat's Butter", 2),
                ing("Raw Goat", 8));
        recipe1("Stonestream Lurcher Sandwich", 4, ing("Goat's Butter", 1), ing("Turnip", 1),
        ...
        recipe1("Rushwater Lurcher Sandwich",   6, ing("Rushwater Lurcher", 1), ing("Potato", 2),
        ...
        recipe("Beef Sandwich",                8, ing("Bread", 36), ing("Cow's Butter", 18),
                ing("Raw Beef", 72));
        recipe1("Thunderfall Lurcher Sandwich", 8, ing("Thunderfall Lurcher", 1), ing("Pumpkin", 6),
    ...
    /** Single-item batch (fish/sea creature variant food — produces 1 per craft) */
    @SafeVarargs
    private static void recipe1(String name, int tier, Ingredient... ingredients) {
        RECIPES.put(name, new Recipe(name, tier, List.of(ingredients), 1));
    }
